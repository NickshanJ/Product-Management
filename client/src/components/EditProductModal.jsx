    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div className="bg-[#1a1a2e] border border-[#25253a] rounded-2xl w-full max-w-md p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-white text-lg font-bold">Edit Product</h2>
          <button
            onClick={onClose}
        ...
        {/* Product ID badge */}
        <div className="mb-4">
          <span className="text-xs font-mono bg-[#13131e] border border-[#25253a] text-gray-400 px-3 py-1 rounded-full">
            Editing product #{String(product?.id).padStart(3, '0')}
          </span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#13131e] border border-[#25253a] text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-blue-500"
            />
          </div>
          ...
          <div className="flex gap-3 mt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-2 w-full py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold disabled:opacity-50"
            >
